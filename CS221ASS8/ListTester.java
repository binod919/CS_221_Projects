...
public class ListTester {
	...
	private void runTests() {
		...
		// 9 [B] -> addAfter(B) -> [B, A]
		testTwoElementList(B_addAfterB_BA, "B_addAfterB_BA", LIST_BA, STRING_BA);
	...
	private Scenario<Integer> B_addAfterB_BA = () -> B_addAfterB_BA();
	 ...
	 */
	private IndexedUnsortedList<Integer> B_addAfterB_BA() {
		IndexedUnsortedList<Integer> list = newList();
		list.add(ELEMENT_B);

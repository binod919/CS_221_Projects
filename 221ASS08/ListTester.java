...
public class ListTester {
	...
	private void runTests() {
		...
		// 1 newly constructed empty list
		...
		// 20 [A] -> listIterNewIterAddB -> [B,A]
		testTwoElementList(A_listIterNewIterAddA_A, "A_listIterNewIterAddA_A", LIST_BA, STRING_BA);

		// 21 [A] -> listIterAddBafterNextA -> [A, B]
		testTwoElementList(A_listIterAddBafterNextA, "A_listIterAddBafterNextA", LIST_AB, STRING_AB);

		// 22 [A] -> listIterAddBafterPreviousA -> [B, A]
		testTwoElementList(A_listIterAddBafterPreviousA, "A_listIterAddBafterPreviousA", LIST_BA, STRING_BA);
		...
		// 42 [A, B] -> addAfterCA -> [A, C, B]
		testThreeElementList(AB_addAfterCA_ACB, "AB_addAfterCA_ACB", LIST_ACB, STRING_ACB);

		// 43 [A, B] -> addToRear(C) -> [A, B, C]
		testThreeElementList(AB_addToRearC_ABC, "BA_addToRearC_BAC", LIST_ABC, STRING_ABC);
		...
		// 46 [A, B, C] -> IterRemoveB ->[A, C]
		testTwoElementList(ABC_IterRemoveB_AC, "ABC_IterRemoveB_AC", LIST_AC, STRING_AC);

		// 47 [A,B,C] -> iterRemoveAfterNextA -> [B,C]
		testTwoElementList(ABC_iterRemoveAfterNextA_BC, "ABC_iterRemoveAfterNextA_BC", LIST_BC, STRING_BC);

		// 48 [A, B, C] -> IterRemoveC ->[A, B]
		testTwoElementList(ABC_IterRemoveC_AB, "ABC_IterRemoveC_AB", LIST_AB, STRING_AB);

		// 49 [A, B, C] -> listIterRemoveAfterNextA -> [B, C]
		testTwoElementList(ABC_listIterRemoveAfterNextA_BC, "ABC_listIterRemoveAfterA_BC", LIST_BC, STRING_BC);

		// 50 [A, B, C] -> listIterRemoveAfterNextB -> [A, C]
		testTwoElementList(ABC_listIterRemoveAfterNextB_AC, "ABC_listIterRemoveAfterB_AC", LIST_AC, STRING_AC);

		// 51 [A, B, C] -> listIterRemoveAfterNextC -> [A, B]
		testTwoElementList(ABC_listIterRemoveAfterNextC_AB, "ABC_listIterRemoveAfterC_AB", LIST_AB, STRING_AB);

		// 52 [A, B, C] -> removeFirst -> [B, C]
		testTwoElementList(ABC_removeFirst_BC, "ABC_removeFirst_BC", LIST_BC, STRING_BC);

		// 53 [A, B, C] -> removeLast -> [A, B]
		testTwoElementList(ABC_removeLast_AB, "ABC_removeLast_AB", LIST_AB, STRING_AB);

		// 54 [A, B, C] -> removeA -> [B, C]
		testTwoElementList(ABC_removeA_BC, "ABC_removeA_BC", LIST_BC, STRING_BC);

		// 55 [A, B, C] -> removeB> [A, C]
		testTwoElementList(ABC_removeB_AC, "ABC_removeB_AC", LIST_AC, STRING_AC);

		// 56 [A, B, C] -> removeC -> [A, B]
		testTwoElementList(ABC_removeC_AB, "ABC_removeC_AB", LIST_AB, STRING_AB);

		// 57 [A, B, C] -> remove0 -> [B, C]
		testTwoElementList(ABC_remove0_BC, "ABC_remove0_BC", LIST_BC, STRING_BC);

		// 58 [A, B, C] -> remove1 -> [A, C]
		testTwoElementList(ABC_remove1_AC, "ABC_remove1_AC", LIST_AC, STRING_AC);

		// 59 [A, B, C] -> remove2 -> [A, B]
		testTwoElementList(ABC_remove2_AB, "ABC_remove2_AB", LIST_AB, STRING_AB);

		// 60 [A, B, C] -> listIteratorRemoveAfterPreviousA -> [B, C]
		testTwoElementList(ABC_listIterRemoveAfterPreviousA_BC, "ABC_listIterRemoveAfterPreviousA_BC", LIST_BC,
				STRING_BC);

		// 61 [A, B, C] -> listIteratorRemoveAfterPreviousB -> [A, C]
		testTwoElementList(ABC_listIterRemoveAfterPreviousB_AC, "ABC_listIterRemoveAfterPreviousB_AC", LIST_AC,
				STRING_AC);

		// 62 [A, B, C] -> listIteratorRemoveAfterPreviousC -> [A, B]
		testTwoElementList(ABC_listIterRemoveAfterPreviousC_AB, "ABC_listIterRemoveAfterPreviousC_AB", LIST_AB,
				STRING_AB);

		// 3-element to changed 3-element via set()

		// 63 [A, B, C] -> set0D -> [D, B, C]
		testThreeElementList(ABC_set0D_DBC, "ABC_set0D_DBC", LIST_DBC, STRING_DBC);

		// 64 [A,B, C] -> set1D -> [A, D, C]
		testThreeElementList(ABC_set1D_ADC, "ABC_set1D_ADC", LIST_ADC, STRING_ADC);

		// 65 [A,B, C] -> set2D -> [A, B, D]
	...
	/**
	 * Scenario: [B] -> addAfter(B) -> [B,A]
	 * 
	 * @return [B,A] after addAfter(B)
	 */
	...
	/**
	 * Scenario: [A, B, C] -> set0D -> [D,B,C]
	 * 
	 * @return [D, B, C] after set0D
	 */
	...
	/**
	 * Scenario: [A] -> iteratorRemoveAfterNext -> [ ]
	 * 
	 * @return [ ] after iteratorRemoveAfterNext
	 */
	...
	/**
	 * [A, B, C] -> IterRemoveB ->[A, C]
	 * 
	 * @return [A, C] after IterRemoveB
	 */
	...
	/**
	 * [A, B, C] -> IterRemoveC ->[A, B]
	 * 
	 * @return [A, B, C] -> IterRemoveC ->[A, B]
	 */
	...
	/**
	 * [A, B, C] -> listIterRemoveAfterNextA ->[B, C]
	 * 
	...
	/**
	 * [A, B, C] -> listIterRemoveAfterNextB ->[A, C]
	 * 
	...
	/**
	 * [A, B, C] -> listIterRemoveAfterNextC ->[A, B]
	 * 
	 ...
	 * [A, B] -> iterRemoveB -> [A]
	 * 
	 * @return [B] after iterRemoveB
	 */
	private IndexedUnsortedList<Integer> AB_iterRemoveAfterB_A() {
		IndexedUnsortedList<Integer> list = emptyList_addToRearA_A();
		list.add(ELEMENT_B);
		Iterator<Integer> it = list.iterator();
		it.next();
	...
	private Scenario<Integer> AB_iterRemoveAfterB_A = () -> AB_iterRemoveAfterB_A();

	/**
	 * [A, B] -> listIterRemoveAfterNextB -> [A]
	 * 
	 * @return [B] after listIterRemoveAfterNextB
	 */
	private IndexedUnsortedList<Integer> AB_listIteratorRemoveAfterNextA_B() {
		IndexedUnsortedList<Integer> list = emptyList_addToRearA_A();
		list.add(ELEMENT_B);
		Iterator<Integer> it = list.iterator();
		it.next();
	...
	private Scenario<Integer> AB_iterRemoveAfterNextA_B = () -> AB_listIteratorRemoveAfterNextA_B();
	 ...
	 * @return [B] after listIterRemoveAfterNextB
	 */
	private IndexedUnsortedList<Integer> AB_listIteratorRemoveAfterNextB_A() {
		IndexedUnsortedList<Integer> list = emptyList_addToRearA_A();
		list.add(ELEMENT_B);
		Iterator<Integer> it = list.iterator();
		it.next();
	...
	private Scenario<Integer> AB_iterRemoveAfterNextB_A = () -> AB_listIteratorRemoveAfterNextB_A();

	/**
	 * [A,B,C] -> iterRemoveAfterB -> [B,C]
	 * 
	 * @return [B, C] after iterRemoveAfterB
	 */
	private IndexedUnsortedList<Integer> ABC_iterRemoveAfterNextA_BC() {
		IndexedUnsortedList<Integer> list = ABC_IterRemoveC_AB();
		list.add(ELEMENT_C);
		Iterator<Integer> it = list.iterator();
		it.next();
		it.remove();
	...
	/**
	 * Scenario: [A] -> listIterRemoveAfterPreviousB -> [A]
	 * 
	...
	private Scenario<Integer> A_listIterNewIterAddA_A = () -> A_listIterNewIterAddA_A();
	 ...
	 * @return [A,B] after listIterRemoveAfterPreviousC
	 */
	private IndexedUnsortedList<Integer> A_listIterNewIterAddA_A() {
		IndexedUnsortedList<Integer> list = newList();
		list.add(ELEMENT_A);
		ListIterator<Integer> it = list.listIterator();
	...
	private Scenario<Integer> A_listIterAddBafterPreviousA = () -> A_listIterAddBafterPreviousA();

	/**
	 * Scenario: [A] -> listIterAddBafterPreviousA -> [B,A]
	 * 
	 * @return [B,A] after listIterAddBafterNextA
	 */
	private IndexedUnsortedList<Integer> A_listIterAddBafterPreviousA() {
		IndexedUnsortedList<Integer> list = newList();
		list.add(ELEMENT_A);
		ListIterator<Integer> it = list.listIterator();
		it.next();
